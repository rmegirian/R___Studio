---
title: "Interpreting Analysis Outputs: Descriptive Plots"
author: "Rose Megirian"
categories: [Data Analysis]
description: "A guide to reading and interpreting common descriptive plots, including histograms, boxplots, and scatter plots."
...
ggsave("header_hist.png", width = 1200, height = 1200, units = "px", dpi = 72)
```
...
ggsave("header_box.png", width = 1200, height = 1200, units = "px", dpi = 72)
```
...
ggsave("header_scatter.png", width = 1200, height = 1200, units = "px", dpi = 72)
```
